---
title: GameOfThrows Make Gate Aliases
date: 2026-06-09
status: completed
execution: code
---
...
the first gate command fails before reaching the SpriteKit baseline.
...
Full Xcode execution is still skipped locally because `xcodebuild` is not
